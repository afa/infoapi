...
describe SimpleApi::Rule do
  ...
  context "for trw-620" do
    before(:example) do
      @trw620rule_right = SimpleApi::Rule.new(@template.merge filter: "{\"criteria\":\"any\", \"path\":\"empty\",\"stars\":\"empty\",\"years\":\"empty\"}", name: 'yearrul', traversal_order: '[]')
      @trw620rule = SimpleApi::Rule.new(@template.merge filter: "{\"criteria\":\"any\", \"path\":\"empty\",\"stars\":\"empty\",\"year\":\"empty\"}", name: 'yearrul', traversal_order: '[]')
  ...
  context "on rules loading" do
    context "when rule sphere unknown" do
      before(:example) do
        ...
        @trw620rule_right = SimpleApi::Rule.new(@template.merge sphere: 'abyrvalg', filter: "{\"criteria\":\"any\", \"path\":\"empty\",\"stars\":\"empty\",\"years\":\"empty\"}", name: 'yearrul', traversal_order: '[]')
        @trw620rule = SimpleApi::Rule.new(@template.merge filter: "{\"criteria\":\"any\", \"path\":\"empty\",\"stars\":\"empty\",\"year\":\"empty\"}", name: 'yearrul', traversal_order: '[]')
